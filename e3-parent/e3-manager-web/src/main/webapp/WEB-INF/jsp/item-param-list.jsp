...
<table class="easyui-datagrid" id="itemParamList" title="商品列表" 
    ...
    <thead>
        <tr>
        	...
        	<th data-options="field:'title',width:600">商品标题</th>
        	<th data-options="field:'cid',width:100">叶子类目</th>
        	<th data-options="field:'sellPoint',width:300">卖点</th>
        	<th data-options="field:'sellPoint',width:70,align:'right',formatter:E3.formatPrice">价格</th>
            <th data-options="field:'sellPoint',width:70">库存数量</th>
            <th data-options="field:'sellPoint',width:100">条形码</th>
